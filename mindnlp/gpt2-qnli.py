import pandas as pd
from mindnlp.transformers import AutoTokenizer, GPT2ForSequenceClassification
...
if __name__ == '__main__':
    ...
    model=GPT2ForSequenceClassification.from_pretrained("tanganke/gpt2_qnli", num_labels=2)
