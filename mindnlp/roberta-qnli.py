import pandas as pd
from mindnlp.transformers import AutoTokenizer, RobertaForSequenceClassification
...
if __name__ == '__main__':
    ...
    model=RobertaForSequenceClassification.from_pretrained("howey/roberta-large-qnli", num_labels=2)
